<!-- header -->
 ...
 $pageMeta = getPageMeta('sports-shop');
  $pageTitle = $pageMeta['page_title'] ?? 'sports-shop';
      ...
      <div class="row">
         ...
         <div class="col-md-5">
            <div class="inner-banner-img">
               <figure>
                  <img src="assets/images/img275.png">
               </figure>
            </div>
         </div>
      </div>
                  ...
                  <div class="col-md-3 col-12 mb-4">
                     <div class="boxes flip-container">
                        <div class="flip-card">
                           <div class="flip-card-inner">
                              <div class="flip-card-back">
                                 <img src="assets/images/fe4.png" alt="E-commerce Integration" class="img-fluid mb-3">
                  ...
                  <div class="col-md-3 col-12 mb-4">
                     <div class="boxes flip-container">
                        <div class="flip-card">
                           <div class="flip-card-inner">
                              <div class="flip-card-back">
                                 <img src="assets/images/fe5.png" alt="Reporting & Analytics" class="img-fluid mb-3">
                  ...
                  <div class="col-md-3 col-12 mb-4">
                     <div class="boxes flip-container">
                        <div class="flip-card">
                           <div class="flip-card-inner">
                              <div class="flip-card-back">
                                 <img src="assets/images/fe6.png" alt="Custom Integrations" class="img-fluid mb-3">
