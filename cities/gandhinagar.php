...
$pageTitle = "#No.1 Top ERP Software in Manufacturing & Retail in Gandhinagar | Digify Soft Solutions";
$pageDescription = "Empower your Gandhinagar business with India's most trusted Cloud-based ERP and CRM solutions. Manage inventory, production, GST billing, and more.";
$pageKeywords = "ERP Software Gandhinagar, Manufacturing ERP Gandhinagar, Retail ERP Gandhinagar, POS Billing Gandhinagar, Cloud ERP India";
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="inner-banner-wrap animate__animated animate__fadeIn">
                    <span class="badge bg-warning text-dark mb-3 px-3 py-2 text-uppercase fw-bold" style="letter-spacing: 2px;">#No.1 ERP Solution in Gandhinagar</span>
                    <h1 class="display-4 fw-bold mb-4">Top ERP Software in Manufacturing & Retail in <span class="text-primary">Gandhinagar</span></h1>
                    <p class="lead text-muted mb-4 px-lg-5">Running a manufacturing or retail business in Gandhinagar requires more than spreadsheets and manual systems. Modern businesses now rely on ERP software to manage inventory, production, accounting, billing, CRM, warehouse management, employees, GST compliance, and analytics from a centralized dashboard.</p>
                    <div class="hero-btn-wrap">
                        <a href="contact-us.php" class="btn btn-primary btn-lg hero-btn-premium hvr-grow">Get Free Demo</a>
                        <a href="cities/gandhinagar.php#features" class="btn btn-outline-primary btn-lg hero-btn-premium hero-btn-outline hvr-grow">Explore Features</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-5">
            <div class="col-lg-6">
                <div class="p-4 bg-white rounded shadow-sm h-100 border-top border-primary border-4 animate__animated animate__fadeInUp">
                    <h3 class="fw-bold mb-4">Why Manufacturing Businesses in Gandhinagar Need ERP</h3>
                    <p class="mb-4">Manufacturing industries in Gandhinagar face multiple operational challenges. Our ERP automates factory operations and improves productivity through:</p>
                    <div class="row g-3">
                        <?php 
...
<section id="features" class="features-sec py-5">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">Powerful modules designed to scale your business in Gandhinagar</p>
        </div>
        <div class="row g-4">
            <!-- Smart POS -->
            <div class="col-md-4">
...
<section class="advantages-sec py-5 bg-dark text-white">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="text-light">Why businesses in Gandhinagar choose our cloud-based solution</p>
        </div>
        <div class="row g-4">
...
<section class="cta-section py-5 bg-warning text-center">
    <div class="container">
        <h2 class="fw-bold mb-4">Ready to transform your Gandhinagar business?</h2>
