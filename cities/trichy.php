<?php 
$cityName = "Trichy";
$pageTitle = "#No.1 Top ERP Software in Manufacturing & Retail in Trichy | Digify Soft Solutions";
$pageDescription = "Leading ERP for Manufacturing and Retail industries in Trichy. Affordable Cloud ERP and AI-powered POS for Trichy businesses.";
$pageKeywords = "ERP Software Trichy, Manufacturing ERP, AI POS Trichy, Cloud ERP Trichy";
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="inner-banner-wrap animate__animated animate__fadeIn">
                    <span class="badge bg-warning text-dark mb-3 px-3 py-2 text-uppercase fw-bold" style="letter-spacing: 2px;">#No.1 ERP Solution for Industry & Retail in Trichy</span>
                    <h1 class="display-4 fw-bold mb-4">Top ERP Software in Manufacturing & Retail in <span class="text-primary">Trichy</span></h1>
                    <p class="lead text-muted mb-4 px-lg-5">Trichy is growing as a key commercial and industrial hub. From local manufacturing units to a booming retail sector, DigifySoft ERP provides the automation tools needed to scale your business efficiently.</p>
                    <div class="hero-btn-wrap">
                        <a href="contact-us.php" class="btn btn-primary btn-lg hero-btn-premium hvr-grow">Get Free Demo</a>
                        <a href="cities/trichy.php#features" class="btn btn-outline-primary btn-lg hero-btn-premium hero-btn-outline hvr-grow">Explore Features</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="industries-overview py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="fw-bold">Supporting Trichy's Business Ecosystem</h2>
            <p class="text-muted">Specialized ERP solutions for Trichy's unique business verticals</p>
        </div>
...
<section class="mfg-sec py-5">
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                <h2 class="fw-bold mb-4">Powerful Manufacturing ERP for Trichy</h2>
                <p class="mb-4">Streamline your production floor with real-time tracking, inventory management, and automated workflows designed for Trichy's industrial sector.</p>
            ...
            <div class="col-lg-6">
                <div class="p-5 bg-dark text-white rounded-4 shadow-lg">
                    ...
                    <p class="mb-4">Empower your Trichy retail store with our next-gen POS and customer management system.</p>
                    ...
                    <p class="small text-muted">Trusted by retailers across Trichy.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="cta-section py-5 bg-warning text-center">
    <div class="container">
        <h2 class="fw-bold mb-4">Elevate Your Trichy Business Today</h2>
        <p class="mb-4 lead fw-bold">Transform your operations with the most trusted ERP in Trichy.</p>
